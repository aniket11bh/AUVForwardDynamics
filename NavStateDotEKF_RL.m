function [ output_args ] = NavStateDotEKF_RL( X , U, tinc)
% NAV_STATE_DOT_EKF_RL calculates estimated value x_dot = f(x_cap,u) and returns x_dot_cap
%
% Inputs :
%   X : [x, y, z, phi, theta, psi, v_bx, v_by, v_bz, w_x, w_y, w_z, a_x, a_y, a_z]
%           Note that, x, y, z are expressed in tangent frame [m],
%                      v_bx, v_by, v_bz expressed in body fixed frame. [m/s]
%                      omega w and accel a's are in gyro and accel. frames respectively.
% 
